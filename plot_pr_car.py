...
rec_pre_cl = np.load("car196_rec_pre_cl.npy")
rec_pre_fcl = np.load("car196_rec_pre_fcl.npy")
rec_pre_tl = np.load("car196_rec_pre_tl.npy")
rec_pre_ftl = np.load("car196_rec_pre_ftl.npy")
